defmodule BlockScoutWeb.AddressChannel do
  ...
  def handle_out(
    ...
    push_current_token_balances(socket, address_current_token_balances, "erc_20", "PRC-20")
    push_current_token_balances(socket, address_current_token_balances, "erc_721", "PRC-721")
    push_current_token_balances(socket, address_current_token_balances, "erc_1155", "PRC-1155")
